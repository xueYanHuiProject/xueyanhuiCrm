<template>
    <el-dialog
        ...
        <div class="block">
            ...
            <el-badge :value="12" class="jurisdiction-item item">
                <el-button size="small">评论</el-button>
            </el-badge>
            <el-badge :value="3" class="jurisdiction-item item">
                <el-button size="small">回复</el-button>
            </el-badge>
            <el-badge :value="1" class="jurisdiction-item item" type="primary">
                <el-button size="small">评论</el-button>
            </el-badge>
            <el-badge :value="2" class="jurisdiction-item item" type="warning">
                <el-button size="small">回复</el-button>
            </el-badge>
        </div>
