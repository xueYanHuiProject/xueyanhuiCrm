<template>
    <el-dialog
        ...
        <span slot="footer" class="dialog-footer">
            ...
            <el-button @click="handleClose" type="default">确定</el-button>
        </span>
    </el-dialog>
</template>
<script>
    ...
    export default {
        ...
        computed:{
            ...mapGetters(['passDialog','addMessage','iconList'])
        },
        watch:{
            addForm:{
                handler(n){
        ...
        methods:{
            ...mapActions(['showPassDialog','hidePassDialog','createColumn','hideMsg']),
            handleClose(){
                let t = this;
                t.hidePassDialog();
                t.addForm = {
