<template>
    <el-form :inline="true" :model="formInline" class="demo-form-inline" label-width="80px" label-position="left">
        <el-form-item label="积分ID">
            <el-input v-model="formInline.id" placeholder="请输入积分ID" class="adminInputEl"></el-input>
        </el-form-item>
        <el-form-item label="积分名称">
            <el-input v-model="formInline.scene" placeholder="请输入积分名称" class="adminInputEl"></el-input>
        </el-form-item>
        <el-form-item label="积分状态">
            <el-select v-model="formInline.status" placeholder="积分状态" class="adminInputEl">
